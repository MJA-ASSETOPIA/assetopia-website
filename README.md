...
- Home uses full-height sections. Small screens and reduced-motion preferences use gentler scrolling.
...
- Review of the legal documents against actual company practices. The public draft-review notice has been removed.
